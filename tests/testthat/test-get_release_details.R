test_that("get release details", {
  ...
  testthat::expect_is(get_release_details(),"data.frame")
  ...
  testthat::expect_is(get_release_details(latest = "current"),"data.frame")
  testthat::expect_is(get_release_details(latest = "current", os = "win"),"data.frame")
